<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="assign_details.aspx.cs" Inherits="Excel_Bus.assign_details" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        /* Reset and base styles for content area */
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-container">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                <label for="ddlBuses">Vehicles</label>
                <asp:DropDownList ID="ddlBuses" runat="server" CssClass="aspNetDropdown">
                    <asp:ListItem Text="Select Vehicle" Value="" />
                </asp:DropDownList>
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                <label for="ddlDrivers">Driver</label>
        ...
        <div class="form-row">
            <div class="form-group">
                <label for="ddlUsers">Conductor</label>
                <asp:DropDownList ID="ddlUsers" runat="server" CssClass="aspNetDropdown">
                    <asp:ListItem Text="Select Conductor" Value="" />
                </asp:DropDownList>
            </div>
        </div>
        ...
        <ContentTemplate>
            <div class="form-container">
                ...
                <div class="table-responsive">
                    <asp:GridView ID="gvAssignments" runat="server" CssClass="table table-bordered" AutoGenerateColumns="false"
                        EmptyDataText="No assignments found." OnRowCommand="gvAssignments_RowCommand" OnRowDataBound="gvAssignments_RowDataBound">
                        <Columns>
                            ...
                            <asp:BoundField DataField="ConductorName" HeaderText="Conductor" />
                            ...
                            <asp:TemplateField HeaderText="Status">
                                <ItemTemplate>
                                    ...
                                    <asp:HiddenField ID="hdnAssignId" runat="server" Value='<%# Eval("AssignId") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <div style="display: flex; gap: 5px; justify-content: center; flex-wrap: nowrap;">
                                        <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="btn-small btn-warning"
                                            CommandName="EditAssignment" CommandArgument='<%# Eval("AssignId") %>' />
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <label for="ddlEditBuses">Vehicles</label>
                            <asp:DropDownList ID="ddlEditBuses" runat="server" CssClass="aspNetDropdown">
                                <asp:ListItem Text="Select Vehicle" Value="" />
                            </asp:DropDownList>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <label for="ddlEditDrivers">Driver</label>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label for="ddlEditUsers">Conductor</label>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scripts" runat="server">
    <script type="text/javascript">
        ...
        function toggleDropdown(dropdownClientId, isEnabled) {
        ...
        window.onload = function () {
            var ddlElements = document.querySelectorAll('.status-dropdown');
            ddlElements.forEach(function (ddl) {
        ...
        // Add Sys.Application ready handler for UpdatePanel
