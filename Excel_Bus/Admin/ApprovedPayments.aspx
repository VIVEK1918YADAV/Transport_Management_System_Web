<%@ Page Title="Approved Deposits" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ApprovedPayments.aspx.cs" Inherits="Excel_Bus.ApprovedPayments" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="approved-payments-container">
        <!-- Page Header -->
        ...
        <asp:Panel ID="pnlNoData" runat="server" CssClass="no-data-panel" Visible="false">
            ...
            <p class="no-data-text">No approved payments found</p>
        </asp:Panel>
    </div>
