<%@ Page Title="Pending Tickets" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="PendingTickets.aspx.cs" Inherits="Excel_Bus.PendingTickets" Async="true" AsyncTimeout="90" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="pending-tickets-page">
        <!-- Header -->
        <div class="pending-tickets-header">
            <h3>
                <i class="las la-clock"></i>Pending Tickets
                <span style="font-size: 18px; color: #666; margin-left: 10px;">(Total:
                    <asp:Literal ID="litTotalPending" runat="server">0</asp:Literal>)
                </span>
            </h3>
            <p style="margin: 0; color: #666; font-size: 14px;">
                Pending Tickets from Transaction Table
            </p>
        </div>
        ...
        <div class="tickets-table-wrapper">
            <asp:Repeater ID="rptPendingTickets" runat="server">
                <HeaderTemplate>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="line-height: 1.6;">
                                ...
                                <a href="javascript:void(0)"
                                    ...
                                    style="color: #0E9E4D; font-size: 12px; text-decoration: none;">@<%# Eval("UserName") %>
                                </a>
                            </div>
                        </td>
                        ...
                        <td>
                            <%# !string.IsNullOrEmpty(Eval("FleetTypeName")?.ToString()) && Eval("FleetTypeName").ToString() != "N/A" 
                                ? "<strong style='color: #0E9E4D;'>" + Eval("FleetTypeName") + "</strong>" 
                        ...
                        <td>
                            <strong><%# Convert.ToDecimal(Eval("SubTotal")).ToString("N2") %> CDF</strong>
                        </td>
                        <td>
                            <div style="font-size: 12px;">
                                <strong>TRX ID:</strong> <%# Eval("TransactionId") %><br />
                                <strong>Amount:</strong> <%# Convert.ToDecimal(Eval("TrxAmount")).ToString("N2") %> CDF
                            </div>
                        </td>
                    </tr>
                </ItemTemplate>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scripts" runat="server">
    <script>
        ...
        $(document).ready(function () {
            console.log('Pending Tickets page loaded');
        });
    </script>
</asp:Content>
