...
namespace Excel_Bus
{
    public partial class AllPayments : System.Web.UI.Page
    {
        ...
        private List<AllPaymentsViewModel> AllPaymentsData
        {
            get
            {
                if (ViewState["AllPaymentsData"] != null)
                    return JsonConvert.DeserializeObject<List<AllPaymentsViewModel>>(ViewState["AllPaymentsData"].ToString());
                return new List<AllPaymentsViewModel>();
            }
        ...
        private async Task LoadAllPayments(string searchTerm = "", string dateRange = "")
        {
            try
            {
                ...
                var transactions = JsonConvert.DeserializeObject<List<AllPaymentsTransactionDto>>(transactionJson);
                ...
                var users = JsonConvert.DeserializeObject<List<AllPaymentsUserDto>>(userJson);
    ...
    public class AllPaymentsTransactionDto
    {
    ...
    public class AllPaymentsUserDto
    {
