<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="busList.aspx.cs" Inherits="Excel_Bus.Admin.busList" Async="true" %>
        ...
        <div class="page-header">
            ...
            <div class="header-actions">
                <div class="search-box">
                    <asp:TextBox ID="txtSearch" runat="server" CssClass="search-input" placeholder="Search by name..." autocomplete="off" OnKeyUp="searchVehicles()" />
