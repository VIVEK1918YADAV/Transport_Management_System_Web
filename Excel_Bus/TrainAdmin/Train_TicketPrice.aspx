<%@ Page Title="" Language="C#" MasterPageFile="~/TrainAdminMaster.Master" AutoEventWireup="true" CodeBehind="Train_TicketPrice.aspx.cs" Inherits="Excel_Bus.TrainAdmin.Train_TicketPrice" Async="true" %>
            ...
            <div class="card">
                <div class="table-responsive">
                    <asp:GridView ID="gvTicketPrices" runat="server" AutoGenerateColumns="False" CssClass="price-table"
                        DataKeyNames="TicketPriceId" OnRowCommand="gvTicketPrices_RowCommand">
                        <Columns>
                            <asp:BoundField DataField="fleetTypeName" HeaderText="Fleet Type" />
                            <asp:BoundField DataField="RouteName" HeaderText="Train Route" />
                            <asp:BoundField DataField="TrainName" HeaderText="Train Name" />
                            <asp:BoundField DataField="CoachTypeName" HeaderText="Coach Name" />
                            <asp:TemplateField HeaderText="Price">
                                <ItemTemplate>
                                    <%# Excel_Bus.TrainAdmin.Train_TicketPrice.FormatPrice(Eval("OnlinePrice")) %>
                                </ItemTemplate>
                            </asp:TemplateField>
        ...
        <asp:Panel ID="pnlAdd" runat="server" Visible="false">
            <div class="form-panel">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label>Train Route <span class="required">*</span></label>
                    <asp:DropDownList ID="ddlRoute" runat="server" CssClass="form-control">
                    </asp:DropDownList>
                </div>

                <div class="form-group">
                    <label>Train Name <span class="required">*</span></label>
                    <asp:DropDownList ID="ddlVehicle" runat="server" CssClass="form-control">
                    </asp:DropDownList>
                </div>

               <div class="form-group">
                    <label>Coach Type <span class="required">*</span></label>
