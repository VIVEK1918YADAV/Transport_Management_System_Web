...
namespace ExcelBus
{
    public partial class Profile : System.Web.UI.Page
    {
        ...
        //    try
        //    {
        //        System.Diagnostics.Debug.WriteLine("=== BUTTON CLICK STARTED ===");

        //        int userId = Convert.ToInt32(hdnUserId.Value);
        //        System.Diagnostics.Debug.WriteLine($"User ID from hidden field: {userId}");
        ...
        //        if (currentUser == null)
        //        {
        //            ViewState["SuccessMessage"] = "Unable to retrieve user information";
        //            ViewState["MessageType"] = "error";
        //            System.Diagnostics.Debug.WriteLine("ERROR: Current user is NULL");
        //            return;
        //        }

        //        System.Diagnostics.Debug.WriteLine($"Current User Retrieved: ID={currentUser.Id}, Email={currentUser.Email}");
        ...
        //        System.Diagnostics.Debug.WriteLine($"Fields to Update:");
        //        System.Diagnostics.Debug.WriteLine($"  Firstname: {currentUser.Firstname}");
        //        System.Diagnostics.Debug.WriteLine($"  Lastname: {currentUser.Lastname}");
        //        System.Diagnostics.Debug.WriteLine($"  City: {currentUser.City}");
        //        System.Diagnostics.Debug.WriteLine($"  State: {currentUser.State}");

        //        // Update profile via API
        //        bool success = await UpdateUserProfile(currentUser);

        //        System.Diagnostics.Debug.WriteLine($"Update Result: {success}");

        //        if (success)
        //        {
        //            // Store success message in ViewState
        //            ViewState["SuccessMessage"] = "Profile updated successfully!";
        ...
        //            string script = "notify('success', 'Profile updated successfully!');";
        //            ScriptManager.RegisterStartupScript(this, GetType(), "successMsg", script, true);
        //        }
        //        else
        //        {
        //            string script = "notify('error', 'Failed to update profile. Please try again.');";
        //            ScriptManager.RegisterStartupScript(this, GetType(), "errorMsg", script, true);
        //        }
        //    }
        //    catch (Exception ex)
        //    {
        //        System.Diagnostics.Debug.WriteLine($"BUTTON CLICK ERROR: {ex.Message}");
        //        string script = "notify('error', 'An error occurred while updating your profile');";
        //        ScriptManager.RegisterStartupScript(this, GetType(), "exceptionMsg", script, true);
        //    }
        //}
