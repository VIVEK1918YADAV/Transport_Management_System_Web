<%@ Page Title="" Language="C#" MasterPageFile="~/TrainUserMaster.Master" AutoEventWireup="true" CodeBehind="Train_Booking_Confirmation.aspx.cs" Inherits="Excel_Bus.Train_Booking_Confirmation" Async="true" %>
                    ...
                    <div class="booking-details-section">
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value">
                                <asp:Label ID="lblTrainName" runat="server" Text="N/A"></asp:Label>
                            </span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Train Number</span>
                            <span class="detail-value">
                                <asp:Label ID="lblTrainNumber" runat="server" Text="N/A"></asp:Label>
                            </span>
                        </div>
                        <div class="detail-item">
