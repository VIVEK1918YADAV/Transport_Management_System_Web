<%@ Page Title="Download Ticket" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DownloadTicket.aspx.cs" Inherits="Excel_Bus.DownloadTicket" Async="true" %>
        ...
        <div class="container">
            <div class="ticket-wrapper">
                ...
                <div class="ticket-header">
                    <h1><i class="fas fa-bus"></i> Excel Bus Ticket</h1>
                ...
                <div class="ticket-footer">
                    <p>
                        ...
                        Please carry a valid ID proof. Present this QR code to the conductor for verification.
                    </p>
                    <p>
                        <strong>Excel Bus Services</strong> | Contact: +91 98717 71849
                    </p>
                </div>
            </div>
        </div>
