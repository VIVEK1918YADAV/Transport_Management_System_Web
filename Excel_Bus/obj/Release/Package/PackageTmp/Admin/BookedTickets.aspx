<%@ Page Title="Booked Tickets" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="BookedTickets.aspx.cs" Inherits="Excel_Bus.BookedTickets" Async="true"  %>
            ...
            <asp:Repeater ID="rptBookedTickets" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <strong style="color: #28c76f;"><%# Convert.ToDecimal(Eval("SubTotal")).ToString("N2") %> CDF</strong>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
