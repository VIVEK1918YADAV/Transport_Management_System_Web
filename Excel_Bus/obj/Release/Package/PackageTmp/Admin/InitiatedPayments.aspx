<%@ Page Title="Initiated Deposits" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="InitiatedPayments.aspx.cs" Inherits="Excel_Bus.InitiatedPayments" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="initiated-payments-container">
        <!-- Page Header -->
        ...
        <asp:Panel ID="pnlNoData" runat="server" CssClass="no-data-panel" Visible="false">
            ...
            <p class="no-data-text">No initiated payments found</p>
        </asp:Panel>
    </div>
                ...
                <div class="detail-section">
                    <div class="detail-card">
                        ...
                        <div class="detail-row">
                            ...
                            <span class="detail-value"><span class="status-badge status-initiated">Initiated</span></span>
                        </div>
                    </div>
