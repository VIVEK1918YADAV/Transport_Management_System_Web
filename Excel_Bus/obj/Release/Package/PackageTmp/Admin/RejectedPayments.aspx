<%@ Page Title="Rejected Deposits" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="RejectedPayments.aspx.cs" Inherits="Excel_Bus.RejectedPayments" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="rejected-payments-container">
        <!-- Page Header -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn-details" 
                                            ...
                                            data-statustext="<%# GetStatusText(Eval("Status")) %>"
        ...
        <asp:Panel ID="pnlNoData" runat="server" CssClass="no-data-panel" Visible="false">
            ...
            <p class="no-data-text">No rejected payments found</p>
        </asp:Panel>
    </div>
            ...
            <div class="modal-body">
                <div class="detail-section">
                    <div class="detail-card">
                        <h3>Deposit Via <span id="detailGateway"></span></h3>
                        ...
                        <div class="detail-row">
                            ...
                            <span class="detail-value">
                                <span class="status-badge" id="detailStatusBadge">Rejected</span>
                            </span>
                        </div>
                        
                        <div class="rejection-reason" id="rejectionReasonBox">
                            <h4>🚫 Rejection Reason</h4>
                            <p id="detailRemark">No reason provided</p>
                        </div>
                    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scripts" runat="server">
    ...
    <script>
        ...
        function showDetails(button) {
            ...
            const remark = button.getAttribute('data-remark') || 'No reason provided';
            const details = button.getAttribute('data-details') || 'No additional details';
            const status = button.getAttribute('data-status') || '5';
            const statusText = button.getAttribute('data-statustext') || 'Rejected';
            ...
            document.getElementById('detailGateway').textContent = 'Bank Deposit';
            document.getElementById('detailMethod').textContent = 'Bank Deposit';
            ...
            document.getElementById('detailRemark').textContent = remark;
            document.getElementById('detailDescription').textContent = details;

            updateStatusBadge(status, statusText);

            const rejectionBox = document.getElementById('rejectionReasonBox');
            if (status === '5' && remark && remark !== 'No reason provided') {
        ...
        function updateStatusBadge(status, statusText) {
            ...
            switch (status) {
                case '5':
                    ...
                    badge.textContent = statusText || 'Rejected';
                    break;
                case '1':
                    badge.classList.add('status-booked');
                    badge.textContent = statusText || 'Approved';
                    break;
                case '2':
                    badge.classList.add('status-pending');
                    badge.textContent = statusText || 'Pending';
                    break;
                case '3':
                    badge.classList.add('status-cancelled');
                    badge.textContent = statusText || 'Cancelled';
                    break;
                case '4':
                    badge.classList.add('status-postponed');
                    badge.textContent = statusText || 'Postponed';
                    break;
                default:
                    badge.classList.add('status-rejected');
                    badge.textContent = statusText || 'Rejected';
