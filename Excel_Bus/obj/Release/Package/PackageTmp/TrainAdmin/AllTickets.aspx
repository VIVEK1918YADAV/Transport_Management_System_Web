<%@ Page Title="" Language="C#" MasterPageFile="~/TrainAdminMaster.Master" AutoEventWireup="true" CodeBehind="AllTickets.aspx.cs" Inherits="Excel_Bus.TrainAdmin.AllTickets" Async="true" %>
        ...
        <div class="tickets-table-wrapper">
            <asp:Repeater ID="rptAllTickets" runat="server">
                ...
                <ItemTemplate>
                    ...
                    <tr data-ticket-id="<%# Eval("BookingId") %>">
                        ...
                        <%-- FIX: Use TrainName instead of VehicleNickName (not in ViewModel) --%>
                        <td><%# Eval("TrainName") %></td>
            ...
            <div class="pagination-wrapper">
                ...
                <div class="page-size-selector">
                    ...
                    <%-- FIX: Default matches PageSize default of 25 in code-behind --%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scripts" runat="server">
    <script>
        ...
        function highlightStatusRows() {
            // FIX: Status is column 12 (index 12), corrected from nth-child(10)
            $('.tickets-table tbody tr').each(function () {
                var statusBadge = $(this).find('td:nth-child(12)').text().trim();
