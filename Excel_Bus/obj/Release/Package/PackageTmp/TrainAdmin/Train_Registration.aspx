<%@ Page Title="" Language="C#" MasterPageFile="~/TrainAdminMaster.Master" AutoEventWireup="true" CodeBehind="Train_Registration.aspx.cs" Inherits="Excel_Bus.Train_Registration" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="vehicles-page">
        ...
        <div class="page-header">
            <h1 class="page-title">All Trains</h1>
        ...
        <div class="card">
            <div class="table-responsive">
                <asp:GridView ID="gvTrains" runat="server" CssClass="vehicles-table" AutoGenerateColumns="false"
                    OnRowCommand="gvTrains_RowCommand" GridLines="None" DataKeyNames="Id">
                    <Columns>
                        <asp:BoundField DataField="TrainNumber" HeaderText="Train Number" />
                        ...
                        <%-- Day Off: converted string from API e.g. "Friday" --%>
                        ...
                        <%-- Fleet Type: directly from FleetTypeName field --%>
                        <asp:TemplateField HeaderText="Fleet Type">
                            <ItemTemplate>
                                <%# GetFleetTypeName(Eval("FleetTypeName")) %>
                            </ItemTemplate>
                        </asp:TemplateField>
        ...
        <!-- Modal -->
        <div id="TrainModel" class="modal-overlay">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <asp:HiddenField ID="hdnTrainId"      runat="server" Value="0" />
                    ...
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rfvTrainNumber" runat="server"
                            ControlToValidate="txtTrainNumber"
                            ErrorMessage="Train Number is required"
                            ForeColor="Red" Display="Dynamic"
                            ValidationGroup="TrainValidation" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rfvTrainName" runat="server"
                            ControlToValidate="txtTrainName"
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="btn-submit"
                        OnClick="btnSubmit_Click" ValidationGroup="TrainValidation" />
                </div>
            </div>
        </div>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="scripts" runat="server">
    <script type="text/javascript">
        ...
        function openAddNewModal() {
            ...
            if (lblModalTitle) lblModalTitle.textContent = 'Add New Train';

            setTimeout(function () { showModal(); }, 100);
            return false;
        }

        function clearTrainForm() {
            var hdnTrainId = document.getElementById('<%= hdnTrainId.ClientID %>');
            if (hdnTrainId) hdnTrainId.value = '0';

            var txtTrainName = document.getElementById('<%= txtTrainName.ClientID %>');
            if (txtTrainName) { txtTrainName.value = ''; txtTrainName.disabled = false; }

            var txtTrainNumber = document.getElementById('<%= txtTrainNumber.ClientID %>');
            if (txtTrainNumber) txtTrainNumber.value = '';
            ...
            if (txtModelNo) { txtModelNo.value = ''; txtModelNo.disabled = false; }
            ...
            if (ddlFleetType) { ddlFleetType.selectedIndex = 0; ddlFleetType.disabled = false; }
        ...
        function showModal() {
            var modal = document.getElementById('TrainModel');
        ...
        function removeDayOff(value) {
            selectedDays = selectedDays.filter(function (d) { return d !== value; });
            updateDayOffDisplay();
        }
