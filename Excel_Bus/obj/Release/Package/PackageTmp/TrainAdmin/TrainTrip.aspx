<%@ Page Title="" Language="C#" MasterPageFile="~/TrainAdminMaster.Master" AutoEventWireup="true" CodeBehind="TrainTrip.aspx.cs" Inherits="Excel_Bus.TrainAdmin.TrainTrip" Async="true" %>
    ...
    <div class="trip-container">
        ...
        <div class="trip-table">
            <asp:GridView ID="gvTrips" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:BoundField DataField="RouteName" HeaderText="Trip Name" />
                        ...
                        <ItemTemplate>
                            <div class="action-buttons">
                                ...
                                <asp:LinkButton ID="btnToggleStatus" runat="server"
                                    ...
                                    OnClientClick='<%# "return confirm(\"Are you sure you want to " + (Eval("Status").ToString() == "ACTIVE" ? "disable" : "enable") + " this trip?\");" %>' />
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="ddlTrainNo" runat="server" CssClass="form-control"></asp:DropDownList>
                    </div>
                    <%--<div class="form-group">
                        ...
                        <asp:ListBox ID="ddlFleetType" runat="server" CssClass="form-control" SelectionMode="Multiple" style="height: 120px;"></asp:ListBox>
                    </div>--%>
                    <div class="form-group">
                        <label class="form-label">Fleet Type <span class="required">*</span></label>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="ddlRoute" runat="server" CssClass="form-control"></asp:DropDownList>
                    </div>
                    <div class="form-group">
