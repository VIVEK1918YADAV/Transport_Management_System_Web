<%@ Page Title="" Language="C#" MasterPageFile="~/TrainAdminMaster.Master" AutoEventWireup="true" CodeBehind="Train_DeviceList.aspx.cs" Inherits="Excel_Bus.TrainAdmin.Train_DeviceList" Async="true" %>
        ...
        <div class="card">
            <div class="table-responsive">
                <asp:GridView ID="gvDeviceList" runat="server" CssClass="device-table" AutoGenerateColumns="false" 
                              EmptyDataText="No devices found." DataKeyNames="deviceId"
