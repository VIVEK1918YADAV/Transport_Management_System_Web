    ...
    public partial class AdminMaster : System.Web.UI.MasterPage
    {
        ...
        private void LoadAdminProfile()
        {
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    var profile = JsonConvert.DeserializeObject<AdminProfile>(jsonResult);
        ...
        private void LoadNotifications()
        {
            try
            {
                ...
                {
                    var jsonResult = response.Content.ReadAsStringAsync().Result;
                    var notifications = JsonConvert.DeserializeObject<List<AdminNotification>>(jsonResult);
        ...
        {
            var dummyNotifications = new List<AdminNotification>
            {
        ...
        private void LoadBadgeCounts()
        {
            try
            {
                ...
                {
                    var jsonResult = response.Content.ReadAsStringAsync().Result;
                    var badges = JsonConvert.DeserializeObject<BadgeCounts>(jsonResult);
    ...
    void user_access(string username)
    {
        try
        {
            using (var client = new HttpClient())
            {
                ...
                HttpResponseMessage Res = client.GetAsync(apiUrl + string.Format("TblAccessRight/GetTblAccessRight?UserId=" + username)).Result;
