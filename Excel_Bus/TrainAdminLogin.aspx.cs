...
namespace ExcelBus
{
    public partial class TrainAdminLogin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (adminId == "8")
                    Response.Redirect("TrainAdmin/Train_AdminDashboard.aspx", false);
            }
        }
        ...
        private async Task LoginAsync()
        {
            ...
            try
            {
                ...
                if (result != null && result.Success)
                {
                    ...
                    if (userRoleId == 8)
                    {
                        //Response.Redirect("~TrainAdmin/TrainAdminDashboard.aspx", false);
                        Response.Redirect(ResolveUrl("TrainAdmin/Train_AdminDashboard.aspx"), false);
                ...
                //Response.AddHeader("REFRESH", "0;URL=AdminDashboard.aspx");
                //}
                //else
                //{
                //    // Login failed
